...
class TxtParserTest {
    ...
    public void getDatabaseTest1(){
        ...
        assertEquals("25-February-2019", Database.CELLOSAURUS.getUpdated());
        assertEquals(0, Database.CELLOSAURUS.getCellLineCount());
        assertEquals(0, Database.CELLOSAURUS.getPublicationCount());
    }
    ...
    public void getSpeciesTest2() {
        System.out.println(Species.DOG.getCellLines());
    ...
    public void getCellLinesTestHuman6() {
        ...
        List<Marker> markers1 = Arrays.asList(
                ...
                new Marker("FGA", "24"),
                new Marker("Penta D", "9", "10"),
                new Marker("Penta E", "7", "12"),
                new Marker("SE33", "21"),
                new Marker("TH01", "6"),
                new Marker("TPOX", "11"),
                new Marker("vWA", "18")
