...
$(function(){dialogImport=$("#dialog-import").dialog({autoOpen:!1,height:550,width:500,modal:!1,resizable:!1,closeText:null,hide:{effect:"fold",duration:300},show:{effect:"fold",duration:300},buttons:[{text:"Batch Query",disabled:!0,id:"batch",click:function(){html.addClass("waiting");$.ajax({type:"POST",url:"http://"+ip+":8080/str-sst/api/batch",data:JSON.stringify(jsonInput),contentType:"application/json",dataType:"text",mimeType:"text/plain; charset=x-user-defined",success:function(a,b,c){b="";
            ...
            error:function(a,b,c){console.log(a);console.log(b);console.log(c);alert("Error: The server is not responding\nPlease contact an administrator")},complete:function(){html.removeClass("waiting")}})}},{text:"Close",click:function(){dialogImport.dialog("close")}}]});dialogImport.find("form").on("submit",function(a){a.preventDefault()});dialogExport=$("#dialog-export").dialog({autoOpen:!1,height:350,width:450,modal:!0,resizable:!1,closeText:null,hide:{effect:"fold",duration:300},show:{effect:"fold",duration:300},
    buttons:{Save:function(){jsonResponse.description=$("#description").val();switch(document.getElementById("extension").value){case "csv":exportTable.toCSV($("#name").val());break;case "json":exportTable.toJson($("#name").val());break;case "pdf":exportTable.toPdf($("#name").val())}dialogExport.dialog("close")},Close:function(){dialogExport.dialog("close")}},open:function(){$("#content").addClass("blur")},close:function(){$("#content").removeClass("blur")}});dialogExport.find("form").on("submit",function(a){a.preventDefault()});
    $(document).tooltip({content:function(){return $(this).prop("title")},position:{my:"left center",at:"right+15 center"},show:null,close:function(a,b){b.tooltip.hover(function(){$(this).stop(!0).fadeTo(400,1)},function(){$(this).fadeOut("400",function(){$(this).remove()})})}})});