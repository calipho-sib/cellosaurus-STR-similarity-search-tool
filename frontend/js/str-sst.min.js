...
function resetAll(){resetMarkers();document.getElementById("input-tanabe").checked=!0;document.getElementById("input-nonempty").checked=!0;document.getElementById("check-include-Amelogenin").checked=!1;document.getElementById("filter-score").value=60;document.getElementById("filter-size").value=200;document.getElementById("results").style.display="none";document.getElementById("warning").style.display="none";document.getElementById("importExtension").value="xlsx";document.getElementById("exportExtension").value=
    "xlsx";document.getElementById("inputFile").value="";document.getElementById("importHelp").innerHTML="";document.getElementById("samples").innerHTML="";document.getElementById("sample-label").innerHTML="";document.getElementById("sample-label").style.display="none";document.getElementById("warning").style.opacity="0";document.getElementById("results").style.opacity="0"}
